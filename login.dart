      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            "login",
            style: TextStyle(
              color: Color.fromARGB(255, 226, 9, 9),
              fontSize: 30,
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor: (const Color.fromARGB(255, 221, 8, 8)),
              ),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 15,
                  color: const Color.fromARGB(255, 248, 82, 5),
                ),
              ),
            ),
          ),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 15,
                  color: const Color.fromARGB(255, 224, 46, 1),
                ),
              ),
            ),
          ),
